...
mvn install:install-file -Dfile=Qrcode.jar -DgroupId=com.swetake.util -DartifactId=Qrcode -Dversion=1.0.0 -Dpackaging=jar
mvn install:install-file -Dfile=ss_css2.jar -DgroupId=com.steadystate.css.parser -DartifactId=ss_css2 -Dversion=1.0.0 -Dpackaging=jar
...
mvn install:install-file -Dfile=jss-4.3.2.jar -DgroupId=org.mozilla -DartifactId=jss -Dversion=4.3.2 -Dpackaging=jar
