...
[@entrevista]
	...
	[/@grupo]
	[@grupo]
		[@texto var="num_portaria" titulo="Portaria de Designação"  largura="10" maxcaracteres="10" obrigatorio="true"/]
	[/@grupo]
	[@grupo]
		[@data var="dt_portaria" titulo="Data da Portaria:" obrigatorio=true/]
	[/@grupo]
...
[@entrevista]
	...
	[/@grupo]
	[@grupo]
		[@selecao var="preposicao" titulo="" opcoes= "da;do"/]
		[@texto var="unidade" titulo="Unidade"  largura="50" maxcaracteres="100" obrigatorio="true"/]
	[/@grupo]
	[@grupo]
		[@selecao var="codigo_func" titulo="Código da Função" opcoes= codigos_fg!/]
	[/@grupo]
[/@entrevista]
...
[@entrevista]
	...
	[/@grupo]
	[@grupo]
		[@selecao var="cidade_unidade" titulo="Cidade onde se localiza a unidade"  opcoes= localidades!/]
	[/@grupo]
	[@grupo]
	...
	[/@grupo]
	[@grupo]
		[@data var="dt_publicacao_dou" titulo="Data de Publicação no Diário Oficial da União:"  obrigatorio=true/]
	[/@grupo]
	[@grupo]
		[@selecao var="codigo_func" titulo="Código da Função" opcoes= codigos_fg!/]
	[/@grupo]
