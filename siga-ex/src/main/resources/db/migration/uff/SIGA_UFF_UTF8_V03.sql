...
insert into corporativo.cp_configuracao (id_configuracao, id_tp_configuracao, id_sit_configuracao, his_dt_ini) values (CORPORATIVO.CP_CONFIGURACAO_SEQ.nextval, 2, 1, sysdate);
