...
public class Correio {
	...
	public static void enviar(final String destinatario, final String assunto, final String conteudo) throws Exception {
		...
		Correio.enviar(SigaBaseProperties.getString("servidor.smtp.usuario.remetente"), to, assunto, conteudo, null);
	}	

	public static void enviar(final String remetente, final String[] destinatarios, final String assunto, 
			final String conteudo, final String conteudoHTML)
			throws Exception {
		...
		props.put("mail.smtp.starttls.enable", SigaBaseProperties.getString("servidor.mail.smtp.starttls.enable"));

		// Cria sessão. setDebug(true) é interessante pois mostra os passos 
		// do envio da mensagem e o recebimento da mensagem do servidor no console.
		...
		try {
			...
			// Adiciona conteúdo a mensagem
			msg.setSubject(assunto);
			
			MailContentBuilder mailContentBuilder = new MailContentBuilder();
	        final Multipart mpMixed = mailContentBuilder.build(conteudo, conteudoHTML, null, null);
	...
	public static void enviar(String remetente, String[] destinatarios, String assunto, String conteudo) throws Exception {
