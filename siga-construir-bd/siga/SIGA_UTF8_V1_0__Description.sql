...
--------------------------------------------------------
  ...
  CREATE TABLE "SIGA"."EX_DOCUMENTO" 
   ...
   COMMENT ON COLUMN "SIGA"."EX_DOCUMENTO"."FG_ELETRONICO" IS 'Esta flag indica se o documento é eletrônico ou não.';
...
Insert into SIGA.EX_FORMA_DOCUMENTO (ID_FORMA_DOC,DESCR_FORMA_DOC,SIGLA_FORMA_DOC,ID_TIPO_FORMA_DOC) values (15,'Certidão','CET',1);
...
Insert into SIGA.EX_FORMA_DOCUMENTO (ID_FORMA_DOC,DESCR_FORMA_DOC,SIGLA_FORMA_DOC,ID_TIPO_FORMA_DOC) values (60,'Anexo','ANE',1);
Insert into SIGA.EX_FORMA_DOCUMENTO (ID_FORMA_DOC,DESCR_FORMA_DOC,SIGLA_FORMA_DOC,ID_TIPO_FORMA_DOC) values (6,'Portaria','POR',1);

--REM INSERTING into SIGA.EX_MOBIL

Insert into SIGA.EX_MODELO (ID_MOD,NM_MOD,DESC_MOD,CONTEUDO_TP_BLOB,NM_ARQ_MOD,ID_CLASSIFICACAO,ID_FORMA_DOC,ID_CLASS_CRIACAO_VIA,ID_NIVEL_ACESSO) values (26,'Memorando','Memorando patronizado','template/freemarker','memorando.jsp',null,2,null,null);
...
Insert into SIGA.EX_MODELO (ID_MOD,NM_MOD,DESC_MOD,CONTEUDO_TP_BLOB,NM_ARQ_MOD,ID_CLASSIFICACAO,ID_FORMA_DOC,ID_CLASS_CRIACAO_VIA,ID_NIVEL_ACESSO) values (507,'Anexo',null,null,'anexo.jsp',null,60,null,null);
...
Insert into SIGA.EX_MODELO (ID_MOD,NM_MOD,DESC_MOD,CONTEUDO_TP_BLOB,NM_ARQ_MOD,ID_CLASSIFICACAO,ID_FORMA_DOC,ID_CLASS_CRIACAO_VIA,ID_NIVEL_ACESSO) values (544,'Processo Administrativo',null,null,'processoAdministrativo.jsp',null,55,null,null);
Insert into SIGA.EX_MODELO (ID_MOD,NM_MOD,DESC_MOD,CONTEUDO_TP_BLOB,NM_ARQ_MOD,ID_CLASSIFICACAO,ID_FORMA_DOC,ID_CLASS_CRIACAO_VIA,ID_NIVEL_ACESSO) values (665,'Despacho Automático','Despacho gerado automaticamente pela transferência','template/freemarker',null,null,60,null,null);
...
--Insert into SIGA.EX_NIVEL_ACESSO (ID_NIVEL_ACESSO,NM_NIVEL_ACESSO,DSC_NIVEL_ACESSO,GRAU_NIVEL_ACESSO) values (2,'Limitado de subsecretaria para pessoa','Dá acesso a toda a subsecretaria onde o documento foi criado e também a qualquer lotação (ou apenas pessoa específica) para onde for enviado',40);
...
--Insert into SIGA.EX_NIVEL_ACESSO (ID_NIVEL_ACESSO,NM_NIVEL_ACESSO,DSC_NIVEL_ACESSO,GRAU_NIVEL_ACESSO) values (7,'Limitado de pessoa para subsecretaria','Dá acesso somente ao cadastrante do documento e a toda a subsecretaria para onde for enviado',30);
...
Insert into SIGA.EX_TP_FORMA_DOC (ID_FORMA_DOC,ID_TP_DOC) values (15,1);
Insert into SIGA.EX_TP_FORMA_DOC (ID_FORMA_DOC,ID_TP_DOC) values (15,2);
Insert into SIGA.EX_TP_FORMA_DOC (ID_FORMA_DOC,ID_TP_DOC) values (55,1);
Insert into SIGA.EX_TP_FORMA_DOC (ID_FORMA_DOC,ID_TP_DOC) values (55,2);
Insert into SIGA.EX_TP_FORMA_DOC (ID_FORMA_DOC,ID_TP_DOC) values (60,1);
Insert into SIGA.EX_TP_FORMA_DOC (ID_FORMA_DOC,ID_TP_DOC) values (6,1);
Insert into SIGA.EX_TP_FORMA_DOC (ID_FORMA_DOC,ID_TP_DOC) values (6,2);
...
/* EXECUTAR ESSA PARTE NO SCHEMA SIGA */
