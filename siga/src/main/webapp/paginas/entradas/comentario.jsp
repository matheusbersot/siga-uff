...
<h4 align="center">Você já fez sua Carteirinha UFF?</h4>
<p align="center">
	<a href="http://sistemas.uff.br/saci/"> <img vspace="10"
		hspace="10" alt="" src="/siga/imagens/carteirinhauff.gif"
		height="50px"></img>
	</a>
</p>
...
<c:if test="${param['completo'] eq 'true'}">
	...
	<p>O SIGA apresenta, agora, um design muito mais simples e moderno.
		Além das mudanças estéticas, também foram simplificadas algumas
		páginas e operações, o que beneficia principalmente as pessoas que
		utilizam muito o sistema.</p>
	...
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Consulta a documentos</b><br> Agora é
	...
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Pesquisa por Documentos Sigilosos</b><br>
					A busca textual abrange os documentos com nível de acesso restrito.
					Para incluí-los na pesquisa, marque a opção localizada abaixo do
	...
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Visualizar Dossiê</b><br> O recurso
					...
					imprimir seus conteúdos como um único documento.</font></td>
	</tr>
	...
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Caixa "Ir para o documento"</b><br> O
					campo de busca por código de expediente agora está disponível
	...
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Despacho Longo Diferente</b><br> Ao
					...
					despacho como documento filho, um expediente à parte. Quando este é
					finalizado e assinado, ocorre uma juntada automática ao pai.</font></td>
	</tr>
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
	...
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Pesquisa de Expedientes por
					Cadastrante</b><br> Foi adicionado o campo "Cadastrante" à tela de
					busca por expedientes. Assim, pode-se listar os documentos feitos
					por uma pessoa ou lotação.</font></td>
	</tr>
	...
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Relação de Paternidade Entre
					...
					automaticamente juntado ao pai. É possivel também, na criação de um
					expediente, definir qual o seu documento pai.</font></td>
	</tr>
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
	...
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Assinar É Necessário</b><br> Para
					transferir um documento, agora é preciso antes assiná-lo, a não ser
					que a lotação à qual se envia expresse, por chamado, aceitar
