						...
						<tr class="button">
							<td>
								<div id="dados-assinatura" style="visible: hidden">
									...
									<c:set var="nextURL"
										value="${request.scheme}://${request.serverName}:${request.localPort}/siga/principal.action" />
									...
									<div id="capicom-div" style="display: none;">
										<a id="bot-assinar" href="#"
											...
											class="gt-btn-alternate-large gt-btn-left">Assinar em
											Lote</a>
									</div>

									<p id="ie-firefox-missing" style="display: none;">A
										assinatura digital só poderá ser realizada no Windows através
										do navegador Internet Explorer e no Linux através do navegador
										Mozilla Firefox.</p>
									...
									<p id="capicom-missing" style="display: none;">
										...
										pode ser realizado clicando <a
											href="https://code.google.com/p/projeto-siga/downloads/detail?name=Capicom.zip&can=2&q=#makechanges"><u>aqui</u></a>.
