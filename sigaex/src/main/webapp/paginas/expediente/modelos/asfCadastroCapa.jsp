			...
			<tr bgcolor="#FFFFFF">
				...
				<table align="left" width="100%">
					...
					<c:if test="${not empty f:resource('siga.ex.modelos.cabecalho.subtitulo1')}">
						<tr>
							<td width="100%" align="left">
							<p style="font-family: Arial; font-size: 10pt; font-weight: bold;">${f:resource('siga.ex.modelos.cabecalho.subtitulo1')}L</p>
							</td>
						</tr>
					</c:if>
					<c:if test="${not empty f:resource('siga.ex.modelos.cabecalho.subtitulo2')}">
						<tr>
							<td width="100%" align="left">
							<p style="font-family: Arial; font-size: 10pt; font-weight: bold;">${f:resource('siga.ex.modelos.cabecalho.subtitulo2')}L</p>
							</td>
						</tr>
					</c:if>
					<tr>
